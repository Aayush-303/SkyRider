...
GLfloat fuel=9800;        //fuel left in plane
...
// 	strcpy(string[3],"JUIT");
// 	strcpy(string[2],"Thank you!");
// 	strcpy(string[1],"Ansh");
// 	strcpy(string[0],"Aayush");
// 	strcpy(string[4],"");
...
void RenderScene()
{
	...
	// 	if(!full)
	// 	{
	// 		drawString(-129.0,65.0,0.0,"JUIT");
	// 		setFont(GLUT_BITMAP_HELVETICA_18);
	// 		glColor3f(0.0,0.0,0.0);
	// 		drawString(-90.0,55.0,0.0,"Made By:");
	// 		setFont(GLUT_BITMAP_HELVETICA_18);
	// 		glColor3f(0.0,0.0,0.0);
	// 		drawString(-110.0,45.0,0.0,"Ansh Mehrotra - 211339");
	// 		setFont(GLUT_BITMAP_HELVETICA_18);
	// 		glColor3f(0.0,0.0,0.0);
	// 		drawString(-105.0,35.0,0.0,"Aayush Gupta - 211360");
	// 		setFont(GLUT_BITMAP_HELVETICA_18);
	// 		glColor3f(0.0,0.0,0.0);
	...
	// 	else
	// 	{
	// 		drawString(-105.0,65.0,0.0,"JUIT");
	// 		setFont(GLUT_BITMAP_HELVETICA_18);
	// 		glColor3f(0.0,0.0,0.0);
	// 		drawString(-80.0,55.0,0.0,"Made By:");
	// 		setFont(GLUT_BITMAP_HELVETICA_18);
	// 		glColor3f(0.0,0.0,0.0);
	// 		drawString(-95.0,45.0,0.0,"Ansh Mehrotra - 211339");
	// 		setFont(GLUT_BITMAP_HELVETICA_18);
	// 		glColor3f(0.0,0.0,0.0);
	// 		drawString(-92.0,35.0,0.0,"Aayush Gupta - 211360");
	// 		setFont(GLUT_BITMAP_TIMES_ROMAN_24);
	// 		glColor3f(0.0,0.0,0.0);
